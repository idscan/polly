...
if(DEFINED POLLY_GCC_CXX20_SANDYBRIDGE_PIC_HIDE_NINJA_CMAKE_)
  return()
else()
  set(POLLY_GCC_CXX20_SANDYBRIDGE_PIC_HIDE_NINJA_CMAKE_ 1)
endif()

include("${CMAKE_CURRENT_LIST_DIR}/utilities/polly_init.cmake")

polly_init(
	"gcc / c++20 support / Sandybridge / PIC / hide"
    "Ninja"
)
