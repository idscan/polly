...
if(DEFINED POLLY_IOS_14_3_DEP_9_3_ARM64_SIM64_CXX17_BITCODE_CMAKE_)
  return()
else()
  set(POLLY_IOS_14_3_DEP_9_3_ARM64_SIM64_CXX17_BITCODE_CMAKE_ 1)
endif()
...
polly_init(
  "iOS ${IOS_SDK_VERSION} / Deployment ${IOS_DEPLOYMENT_SDK_VERSION} / Universal (arm64) Simulator (x64 arm64) / \
...
set(IPHONESIMULATOR_ARCHS x86_64 arm64)
